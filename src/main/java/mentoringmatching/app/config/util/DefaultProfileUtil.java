package mentoringmatching.app.config.util;
...
import static mentoringmatching.app.config.AppConstants.SPRING_PROFILE_DEVELOPMENT;

/**
 * Utility class to load a Spring profile to be used as default
 * when there is no {@code spring.profiles.active} set in the environment or as command line argument.
 * If the value is not available in {@code application.yml} then {@code dev}
